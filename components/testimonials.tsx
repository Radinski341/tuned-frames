  ...
  return (
    <div className="relative z-20 py-10 md:py-40">
      ...
      <Subheading className="text-center max-w-lg mx-auto">
        Lynk AI is used by millions of people around the globe.Our No-Code Builder have
        fan bases and people fight for us.
      </Subheading>
      <TestimonialGrid />
    </div>
  );
...
const testimonials = [
  {
    name: "Manu Arora",
    quote:
      "What a fantastic AI Lynk is, I just love it. It has completely transformed the way I approach problems and develop solutions.",
