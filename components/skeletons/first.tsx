    ...
    <div className="relative flex p-8 gap-10 h-full">
      <div className=" w-full md:w-[90%] p-5  mx-auto bg-white dark:bg-neutral-900 shadow-2xl group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2 opacity-20 dark:opacity-60 ">
          <UserMessage>
            I want you to be my assistant. Respond to people.
          </UserMessage>
          <AIMessage>
            Certainly, I will also do lead nurturing and follow-ups.
          </AIMessage>
          <UserMessage>
            How?
          </UserMessage>
          <AIMessage>I&apos;ll send emails.</AIMessage>
          <UserMessage>
            Yes, send emails to my leads and follow up with them.
          </UserMessage>
          <AIMessage>Lead nurturing on!</AIMessage>
        </div>
      </div>
